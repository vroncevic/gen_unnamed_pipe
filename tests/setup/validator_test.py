...
Module
    validator_test.py
Info
    Unit tests for GenUnnamedPipeBundleValidator class.
'''
...
class TestGenUnnamedPipeBundleValidator(unittest.TestCase):
    ...
    def test_validate_bundle_none(self) -> None:
        with self.assertRaises(Exception):
            GenUnnamedPipeBundleValidator.validate(None)

    def test_validate_bundle_invalid_type(self) -> None:
        with self.assertRaises(Exception):
            GenUnnamedPipeBundleValidator.validate("invalid_bundle")
    ...
    def test_is_valid_success(self) -> None:
        ...
        self.assertTrue(GenUnnamedPipeBundleValidator.is_valid(bundle))

    def test_is_valid_failure(self) -> None:
        self.assertFalse(GenUnnamedPipeBundleValidator.is_valid(None))
        self.assertFalse(GenUnnamedPipeBundleValidator.is_valid("invalid"))

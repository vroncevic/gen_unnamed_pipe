...
"""
 ...
 Copyright
     ...
     gen_unnamed_pipe is free software: you can redistribute it and/or
     modify it under the terms of the GNU General Public License as published
     by the Free Software Foundation, either version 3 of the License, or
     (at your option) any later version.
     gen_unnamed_pipe is distributed in the hope that it will be useful,
 ...
 Info
     Define setup for tool gen_unnamed_pipe.
"""
...
setup(
    ...
    package_data={
        'gen_unnamed_pipe': [
            ...
            'log/gen_unnamed_pipe.log'
        ]
    },
    data_files=[(
        '/usr/local/bin/', [
            '{0}{1}'.format(TOOL_DIR, 'run/gen_unnamed_pipe_run.py')
        ]
    )]
)

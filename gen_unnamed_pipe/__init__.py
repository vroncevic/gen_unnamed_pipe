...
class GenUnnamedPipe(CfgCLI):
    '''
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initials GenUnnamedPipe constructor.
    ...
    def __init__(self, verbose: bool = False) -> None:
        ...
        gen_unnamed_pipe_property: Dict[str, str | bool] = {
        ...
        Splash(gen_unnamed_pipe_property, verbose)
        ...
        if self.tool_operational:
            self.add_new_option(
                ...
                help='generate unnamed pipe skeleton (provide name)'
            )
            self.add_new_option(
            ...
            try:
                ...
                try:
                    print(
                        " ".join([
                            f'[{self._GEN_VERBOSE.lower()}]',
                            'generate unnamed pipe skeleton',

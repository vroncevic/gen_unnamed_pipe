...
Info
    Defines GenUnnamedPipeCommandDefinition class.
'''
...
class GenUnnamedPipeCommandDefinition:
    '''
        CLI subcommand metadata definition for unnamed_pipe project generation.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate UnnamedPipe project skeleton'
    ...
    def options(self) -> Sequence[OptionData]:
        ...
        return [
            OptionData(
                name="--name",
                help_text="unnamed_pipe project name",
                action=None,
                default="myapp",
                required=True,
                choices=None,

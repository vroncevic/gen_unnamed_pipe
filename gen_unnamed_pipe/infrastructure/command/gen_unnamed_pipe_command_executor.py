...
Info
    Defines GenUnnamedPipeCommandExecutor class.
'''
...
class GenUnnamedPipeCommandExecutor:
    '''
        Command executor strategy for generating unnamed_pipe project files.
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the GenUnnamedPipeCommandExecutor as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the GenUnnamedPipeCommandExecutor as string representation.

            :return: The GenUnnamedPipeCommandExecutor as string representation.
        '''
        return to_str(self)

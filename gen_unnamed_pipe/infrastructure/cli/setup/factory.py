...
from gen_unnamed_pipe.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_unnamed_pipe.infrastructure.cli.setup.bundle import CLIBundle
from gen_unnamed_pipe.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_unnamed_pipe.infrastructure.command.icommand_definition import ICommandDefinition
from gen_unnamed_pipe.infrastructure.command.icommand_executor import ICommandExecutor
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenUnnamedPipeCommandDefinition()
        service_executor: ICommandExecutor = GenUnnamedPipeCommandExecutor(definition=service_definition)

...
Info
    GenUnnamedPipe bundle dependencies for the gen_unnamed_pipe bundle.
'''
...
class GenUnnamedPipeBundleDependencies(TypedDict):
    '''
        GenUnnamedPipe bundle dependencies for the gen_unnamed_pipe bundle.
        ...
        It defines:
            ...
            :attributes:
                | base - The base bundle with the base components for the gen_unnamed_pipe bundle.
                | service - The service orchestrating the gen_unnamed_pipe's execution for the gen_unnamed_pipe bundle.
                | subprocessor - The adapter executing the gen_unnamed_pipe's sub-processes for the gen_unnamed_pipe bundle.
                | cli - The command-line interface adapter for the gen_unnamed_pipe bundle.
    '''

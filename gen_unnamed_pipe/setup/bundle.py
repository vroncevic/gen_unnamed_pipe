...
Info
    Defines the gen_unnamed_pipe bundle.
'''
...
class GenUnnamedPipeBundle:
    '''
        GenUnnamedPipe bundle holding the components of the gen_unnamed_pipe.

        It defines:

            :attributes:
                | base - The base bundle with the base components.
                | service - The service orchestrating the gen_unnamed_pipe's execution.
                | subprocessor - The adapter executing the gen_unnamed_pipe's sub-processes.
                | cli - The command-line interface adapter.
            :methods:
                | to_dict - Converts the gen_unnamed_pipe bundle to a dictionary.
    '''
    ...
    def to_dict(self) -> dict[str, object]:
        '''
            Converts the gen_unnamed_pipe bundle to a dictionary.

            :return: Dictionary representation of the gen_unnamed_pipe bundle.
            :exceptions: None.
        '''

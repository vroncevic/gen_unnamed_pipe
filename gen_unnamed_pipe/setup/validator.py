...
Info
    A validator for the gen_unnamed_pipe bundle.
'''
...
class GenUnnamedPipeBundleValidator:
    '''
        A validator for the gen_unnamed_pipe bundle.
    ...
    @classmethod
    def validate(cls, bundle: GenUnnamedPipeBundle) -> None:
        '''
            Validates the gen_unnamed_pipe bundle.

            :param bundle: The gen_unnamed_pipe bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_unnamed_pipe_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_unnamed_pipe bundle must be provided'
        msg_bundle_istype: str = 'the gen_unnamed_pipe bundle must be an instance of GenUnnamedPipeBundle'
        ...
        istype(bundle, GenUnnamedPipeBundle, ctx, msg_bundle_istype)

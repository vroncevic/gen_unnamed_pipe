...
RUN mkdir /gen_unnamed_pipe/
COPY gen_unnamed_pipe /gen_unnamed_pipe/
COPY setup.py /
COPY README.md /
RUN find /gen_unnamed_pipe/ -name "*.editorconfig" -type f -exec rm -Rf {} \;
